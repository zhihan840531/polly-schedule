const CACHE='polly-workspace-v4';
const ASSETS=[
  './',
  './index.html',
    ...
    e.respondWith((async()=>{
      try{
        ...
        if(type.includes('text/html')){
          ...
          if(!html.includes('admissions.js')){
            html=html.replace('</body>','<script src="./admissions.js?v=1"></script></body>');
          }
        ...
        if(cached){
          ...
          if(!html.includes('admissions.js')) html=html.replace('</body>','<script src="./admissions.js?v=1"></script></body>');
